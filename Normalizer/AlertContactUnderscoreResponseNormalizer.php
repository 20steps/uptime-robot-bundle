...
class AlertContactUnderscoreResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        if ($type !== 'twentysteps\\Commons\\UptimeRobotBundle\\Model\\AlertContactUnderscoreResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \twentysteps\Commons\UptimeRobotBundle\Model\AlertContactUnderscoreResponse) {
            return true;
        }
        return false;
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \twentysteps\Commons\UptimeRobotBundle\Model\AlertContactUnderscoreResponse();
        ...
        if (property_exists($data, 'alert_contact')) {
            $object->setAlertContact($this->denormalizer->denormalize($data->{'alert_contact'}, 'twentysteps\\Commons\\UptimeRobotBundle\\Model\\AlertContact', 'json', $context));
        }
        return $object;
    }
